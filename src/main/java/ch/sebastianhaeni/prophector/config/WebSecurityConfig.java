...
import ch.sebastianhaeni.prophector.security.jwt.TokenAuthenticationFilter;
import ch.sebastianhaeni.prophector.security.oauth2.*;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        var permittedUrlPatterns = new String[]{
                "/",
                "/*.js",
                "/*.css",
                "/*.ico",
        ...
        http
            ...
            .exceptionHandling()
                ...
                .and()
            .authorizeRequests()
                .antMatchers(permittedUrlPatterns).permitAll()
                .and()
            .authorizeRequests()
    ...
    /**
     * This bean loads the user specific data when a login form is used.
     */
    @Override
